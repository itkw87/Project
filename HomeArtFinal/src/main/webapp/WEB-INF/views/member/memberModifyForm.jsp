...
// 		}
		...
		$("#searchAddress").click(function(){
			new daum.Postcode({ //daum객체 생성 후 Postcode메소드 호출
		        oncomplete: function(data) {//주소창에서 원하는 주소를 클릭하였을때 해당 주소에 대한 정보를 data로 받아옴 
		        	$("#address1").val(data.zonecode); //zonecode는 우편번호
		        	$("#address2").val(data.address); //address는 기본주소
		        	$("#address3").focus(); //zonecode와 address를 자동입력 후에는 상세주소를 직접 입력하게끔  마우스커서가 위치하게 함
		        }
		    }).open();
		});
