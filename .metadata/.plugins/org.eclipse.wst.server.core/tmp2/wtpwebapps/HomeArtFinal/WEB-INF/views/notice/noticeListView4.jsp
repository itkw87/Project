...
<section class="pc-container">
      ...
      <c:forEach var="n" items="${ list4 }">
		 <tr class="contentTr">
	         <td align="center">${ n.noticeNo4 }</td>
	         <td align="center">${ n.noticeTitle4 }</td>
	       	 <td align="center">${ n.views4 }</td>
	         <td align="center">${ n.NCreateDate4 }</td>
	      </tr>
      </c:forEach>
      ...
      <tr align="center" height="20" id="buttonTab">
         <td colspan="6">
            ...
            <c:if test="${ pi.currentPage > 1 }">
               <c:url var="before" value="nlist4.no">
            ...
            <c:forEach var="p" begin="${ pi.startPage }" end="${ pi.endPage }">
               ...
               <c:if test="${ p ne pi.currentPage }">
                  <c:url var="pagination" value="nlist4.no">
            ...
            <c:if test="${ pi.currentPage < pi.maxPage }">
               <c:url var="after" value="nlist4.no">
                  <c:param name="page" value="${ pi.currentPage + 1 }"/>
               </c:url> 
               <a href="${ after }">&gt;</a>
            </c:if>
      ...
      <tr>
         <td colspan="6" align="right" id="buttonTab">
            <c:if test="${   loginUser.id eq 'admin1'}">
               &nbsp; &nbsp; &nbsp;
               <button style="color: white" id = "button" type="button" class="btn" onclick="location.href='ninsertView4.no';">글쓰기</button>
            </c:if>
         </td>
      </tr>
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                       <img src="resources/css/noticeCss/images/return.png" width="580px" height="490px">
...
<!-- [ Main Content ] end -->
	...
	<script>
      $('.contentTr').find("td").click(function() {
         ...
         location.href = 'ndetail4.no?nId=' + nId + "&page=" + ${pi.currentPage};
      });    
   </script>
