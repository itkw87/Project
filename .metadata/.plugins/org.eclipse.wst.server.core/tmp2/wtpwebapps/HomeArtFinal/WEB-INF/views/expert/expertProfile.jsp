...
<%@ include file="../common/menubar.jsp" %>
	<form action="einsert.ex" method="post" enctype="Multipart/form-data">
		<div class="profile">
			<!-- 프로필 사진 -->
...
<!-- 					<input type="file" name="uploadFile" multiple accept="image/*" onchange="readURL(this);"> -->
			...
			<div class="my-profile">
				...
				<div class="info_3">
					<input type="text" name="expertTitle" value="${loginUser.name}&nbsp;전문가 입니다.">
				</div>
			</div>
...
<!-- 						<span class="percentage-badge"></span> -->
				...
				<div class="info">
					<div class="value">
						<div class="collapsed-text-line">
							<textarea rows="15" cols="" name="expertInfo" style="resize:none;"></textarea>
			...
			<div class="my-profile">
				...
				<div class="info">
					<select name="employeeCount" style="width: 200px;">
						<option value="직원 1명 (본인포함)" selected="selected">직원 1명(본인포함)</option>
						<option value="직원 2명">직원 2명</option>
						<option value="직원 3명">직원 3명</option>
						<option value="직원 4명">직원 4명</option>
						<option value="직원 5명">직원 5명</option>
						<option value="직원 10명">직원 10명</option>
						<option value="직원 20명">직원 20명</option>
						<option value="직원 30명">직원 30명</option>
						<option value="직원 40명">직원 40명</option>
						<option value="직원 50명 이상">직원 50명 이상</option>
					</select>
				</div>
			</div>
			...
			<div class="my-profile">
				...
				<div class="info_2">
					<input type="text" name="hireCount">회
				</div>
			</div>
			...
			<div class="my-profile">
				...
				<div class="info_2">
					<input type="text" name="career" value="${loginUser.career}">년
				</div>
			</div>
			...
			<div class="my-profile">
				...
				<div class="info_1">
					<c:set var="workingDay" value="${ loginUser.workingDay }"/>
			...
			<div class="my-profile">
				...
				<%
					...
					String[] timeArr = loginUser.getWorkingTime().split("~");
				%>
				
				<div class="info_1">
					<input type="time" name="workTime1" value="<%= timeArr[0] %>">
					~
					<input type="time" name="workTime2" value="<%= timeArr[1] %>">
				</div>
			</div>
			...
			<div class="my-profile">
				...
				<div class="info">
					<div class="value">
						<div class="collapsed-text-line">
							<textarea rows="15" cols="" name="detailDescription" style="resize:none;"></textarea>
							<div class="collapse-button" style="display: none;"></div>
						</div>
					</div>
				</div>
			...
			<div class="my-profile">
				...
				<div class="info_2">
					...
					<input type="text" name="businessLicense" maxlength="3"> - 
					<input type="text" name="businessLicense" maxlength="2"> - 
					<input type="text" name="businessLicense" maxlength="5">
				</div>
			</div>
...
<!-- 						</div> -->
				...
				<div class="info">
					<c:set var="field" value="${ loginUser.field }"/>
			...
			<div class="save_cancel">
				<button class="save" type="submit">작성하기</button>
				<button class="cancel" onclick="location.href='elist.ex'">목록으로</button>
			</div>
		</div>
	</form>
